---
name: docs_agent
description: Auto-generate API docs, READMEs, migration guides, and changelogs from code changes
model: sonnet
---
...
Auto-generate API docs, READMEs, migration guides, and changelogs from code changes
