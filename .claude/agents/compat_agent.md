---
name: compat_agent
description: Test backward compatibility, detect breaking changes, suggest semver bumps
model: sonnet
---
...
Test backward compatibility, detect breaking changes, suggest semver bumps
