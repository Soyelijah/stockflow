...
export function Expenses() {
  ...
  const fetchExpenses = async (direction: "init" | "next" | "prev" = "init") => {
    setLoading(true);
    try {
  ...
  const filteredExpenses = expenses.filter((exp) => {
    ...
    const matchesCategory =
      selectedCategory === "Todos" || exp.category === selectedCategory;
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-slate-900 rounded-[2.5rem] p-8 text-white flex items-center justify-between overflow-hidden relative group">
          <div className="relative z-10">
            ...
            <h3 className="text-xl font-black tracking-tight truncate max-w-[160px]">
              {topCategory}
            </h3>
          </div>
      ...
      <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden">
        ...
        {!loading && (
          <div className="flex items-center justify-between px-8 py-5 border-t border-slate-100 bg-slate-50/30 rounded-b-[2.3rem]">
              ...
              <div className="p-6 md:p-8 border-b border-slate-50 flex items-center justify-between bg-slate-50/50 shrink-0">
                <div>
                  <h2 className="text-xl md:text-2xl font-black text-slate-800">
                    {editingExpense ? "Editar Gasto" : "Nuevo Registro"}
                  </h2>
                  ...
                  >
                    {isSubmitting ? (
                      ...
                      <>
                        <RefreshCw size={16} />
                        <span>
                          {editingExpense ? "Actualizar" : "Registrar Pago"}
                        </span>
                      </>
                    )}
                  </button>
